...
bool loadMedia()
{
	...
	//Load music
	//~ gMusic = Mix_LoadMUS( "./beat.midi" );
	gMusic = Mix_LoadMUS_RW( SDL_RWFromMem(mix_22050_mono_wav, mix_22050_mono_wav_len), 1);
	// ## Mix_LoadMUS_RW(SDL_RWFromFile(file, "rb"), 1);
